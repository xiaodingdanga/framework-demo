package com.lx.framework.demo2.utils;
...
public class GeneratorUtil {
    ...
    public void codeGenerator() throws IOException {
        ...
        DataSourceConfig.Builder DATA_SOURCE_CONFIG
                = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/mybatisplus?useUnicode=true&characterEncoding=UTF8&useSSL=false&allowMultiQueries=true&serverTimezone=Asia/Shanghai",
                "root",
                "123456");
